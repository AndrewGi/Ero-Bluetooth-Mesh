...
def get_provider():
    ...
    if _provider is None:
        if sys.platform.startswith('linux'):
            from ..providers.linux.linux_provider import LinuxProvider
            _provider = LinuxProvider()
        elif sys.platform.startswith('darwin'):
            from ..providers.macos.macos_provider import MacOSProvider
            _provider = MacOSProvider()

        elif sys.platform.startswith('win32'):
            from ..providers.win32.win32_provider import Win32Provider
